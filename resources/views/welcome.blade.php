            ...
            <div class="flex flex-col md:flex-row items-center gap-12 ">
                <div class="md:w-1/2">
                    ...
                    <p class="text-gray-700 text-lg mb-6 leading-relaxed">
                        SDN Cijedil adalah sekolah yang berkomitmen untuk memberikan pendidikan terbaik kepada siswa-siswinya. Dengan tenaga pengajar yang berkualitas, kami siap mencetak generasi unggul.
                    </p>
            ...
            <div class="max-w-6xl mx-auto px-12">
                <div class="flex flex-col md:flex-row items-center gap-12">
                    ...
                    <div class="md:w-1/2">
                        ...
                        <p class="text-gray-700 text-lg mb-6 leading-relaxed">
                            Alamat lengkap: Kp.Banjarpinang RT.02/RW.5 Desa Cijedil, Cugenang. 43252. Silakan kunjungi kami atau hubungi untuk informasi lebih lanjut.
                        </p>
                        <!-- Tombol Arahkan Saya -->
    ...
    <div class="max-w-6xl mx-auto px-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-10">
            ...
            <div class="bg-gray-50 rounded-lg p-8 text-center hover:shadow-lg transition-all duration-300 border border-gray-200">
                ...
                <p class="text-lg text-gray-600">sdncijedil@gmail.com</p>
            </div>
            <!-- Card Telepon -->
            <div class="bg-gray-50 rounded-lg p-8 text-center hover:shadow-lg transition-all duration-300 border border-gray-200">
                <div class="flex justify-center mb-4">
            ...
            <div class="bg-gray-50 rounded-lg p-8 text-center hover:shadow-lg transition-all duration-300 border border-gray-200">
                ...
                <p class="text-lg text-gray-600">Jl. Raya Cipanas, Desa Cijedil, Cugenang, Cianjur, 43252</p>
            </div>
        </div>
    </div>
</section>
